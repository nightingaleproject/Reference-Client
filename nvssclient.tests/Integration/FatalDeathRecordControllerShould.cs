...
namespace NVSSClient.tests 
{
    ...
    public class FatalDeathRecordControllerShould : IClassFixture<CustomWebApplicationFactory<NVSSClient.Startup>>
    {
        private readonly CustomWebApplicationFactory<NVSSClient.Startup> _factory;
        private readonly HttpClient _client;
    
        public FatalDeathRecordControllerShould(CustomWebApplicationFactory<NVSSClient.Startup> factory)
        {
            _factory = factory;
        ...
        public async Task PostRecords_ShouldSaveMessage()
        {
            ...
            HttpRequestMessage postRequest = new HttpRequestMessage(HttpMethod.Post, "http://localhost:4300/fataldeathrecord/submissions");
        ...
        public async Task PostRecord_ShouldSaveMessage()
        {
            var records = GetTestRecords("test-files/json/FatalDeathRecord.json");
            // Submit that Death Record
            HttpRequestMessage postRequest = new HttpRequestMessage(HttpMethod.Post, "http://localhost:4300/fataldeathrecord/submission");
        ...
        public async Task PostVoidRecords_ShouldSaveMessage()
        {
            ...
            // Submit that Death Record
            HttpRequestMessage postRequest = new HttpRequestMessage(HttpMethod.Post, "http://localhost:4300/fataldeathrecord/voids");
        ...
        public async Task PostVoidRecord_ShouldSaveMessage()
        {
            ...
            // Submit that Death Record
            HttpRequestMessage postRequest = new HttpRequestMessage(HttpMethod.Post, "http://localhost:4300/fataldeathrecord/void");
